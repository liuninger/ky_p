...
(2, 0, '首页', '/index', 2, 0, 0, 0, 0, '首页', 1523673821, 0, 'upload/common/1522638497.png', 1, ''),
(3, 0, '商品分类', '/goods/goodsClassificationList', 2, 1, 0, 0, 0, '商品分类', 1523673821, 0, 'upload/common/1522639301.png', 1, ''),
(4, 0, '限时折扣', '/index/discount', 2, 2, 0, 0, 0, '限时折扣', 1523673821, 0, 'upload/common/1522639420.png', 1, ''),
(5, 0, '品牌专区', '/goods/brandlist', 2, 3, 0, 0, 0, '品牌专区', 1523673821, 0, 'upload/common/1522639938.png', 1, ''),
(6, 0, '标签专区', '/goods/promotionzone', 2, 4, 0, 0, 0, '标签专区', 1523673821, 0, 'upload/common/1522639973.png', 1, ''),
(7, 0, '会员中心', '/member/index', 2, 5, 0, 0, 0, '会员中心', 1523673821, 0, 'upload/common/1522640129.png', 1, ''),
(8, 0, '专题活动', '/goods/promotionTopic', 2, 7, 0, 0, 0, '专题活动', 1523673821, 0, 'upload/common/1522640297.png', 1, ''),
(9, 0, '团购专区', '/goods/groupBuyingArea', 2, 8, 0, 0, 0, '团购专区', 1523673821, 0, 'upload/common/1522640360.png', 1, ''),
(10, 0, '购物车', '/goods/cart', 2, 9, 0, 0, 0, '购物车', 1523673821, 0, 'upload/common/1522640412.png', 1, ''),
(11, 0, '文章中心', '/articlecenter/index', 2, 0, 0, 0, 0, '文章中心', 1526110567, 0, 'upload/common/1524734357.png', 1, '');
...
(7, '团购专区', 'goods/groupBuyingArea', 1, 1, 1523673809, ''),
(8, '专题活动', 'goods/promotionTopic', 1, 1, 1523673809, ''),
(9, '首页', '/index', 1, 2, 1523673820, ''),
(10, '商品分类', '/goods/goodsClassificationList', 1, 2, 1523673820, ''),
(11, '限时折扣', '/index/discount', 1, 2, 1523673820, ''),
(12, '品牌专区', '/goods/brandlist', 1, 2, 1523673820, ''),
(13, '标签专区', '/goods/promotionzone', 1, 2, 1523673820, ''),
(14, '会员中心', '/member/index', 1, 2, 1523673820, ''),
(15, '专题活动', '/goods/promotionTopic', 1, 2, 1523673820, ''),
(16, '团购专区', '/goods/groupBuyingArea', 1, 2, 1523673820, ''),
(17, '购物车', '/goods/cart', 1, 2, 1523673820, ''),
(18, '文章中心', '/articlecenter/index', 1, 2, 1526110567, '');
...
(152, 0, 'UNIONPAY', '', '银联卡支付', 0, 1523673821, 0);
...
(11063, '会员足迹', 'admin', 'member', 'newpath', 145, 3, 'member/newpath', 0, 0, 0, '会员足迹', '', '', 1, 1523673789, 0),
(11064, '团购', 'admin', 'Promotion', 'groupBuyList', 179, 2, 'Promotion/groupBuyList', 1, 0, 10, '团购', '', '', 1, 1523673793, 0),
(11065, '添加团购活动', 'admin', 'promotion', 'addGroupBuy', 11064, 3, 'promotion/addGroupBuy', 1, 0, 1, '添加团购活动', '', '', 1, 1523673793, 0),
(11066, '修改团购活动', 'admin', 'Promotion', 'updateGroupBuy', 11064, 3, 'Promotion/updateGroupBuy', 1, 0, 2, '修改团购活动', '', '', 1, 1523673793, 0),
(11067, '微信小程序管理', 'admin', 'wchat', 'appletConfig', 335, 2, 'wchat/appletConfig', 1, 0, 1, '微信小程序管理', '', '', 1, 1523673793, 0),
(11068, '银联卡支付', 'admin', 'config', 'unionpayconfig', 11045, 3, 'config/unionpayconfig', 1, 0, 3, '银联卡支付', '', '', 1, 1523673793, 0),
(11069, '会员余额明细', 'admin', 'member', 'balancedetail', 145, 3, 'member/balancedetail', 1, 0, 0, '会员余额明细', '', '', 1, 1523673793, 0),
(11070, '通知记录', 'admin', 'config', 'notifylist', 528, 3, 'config/notifylist', 1, 0, 0, '', '', '', 1, 1523673793, 0),
(11071, '操作日志', 'admin', 'auth', 'authLog', 126, 3, 'auth/authLog', 0, 0, 5, '', '', '', 1, 1523673793, 0),
(11072, '发票管理', 'admin', 'order', 'invoiceList', 184, 2, 'order/invoiceList', 1, 0, 15, '', '', '', 1, 1523673793, 0),
(11073, '插件设置', 'admin', 'extend', 'addonsconfig', 10009, 3, 'extend/addonsconfig', 1, 0, 2, '', '', '', 1, 1523673793, 0),
(11074, '客服管理', 'admin', 'Wchat', 'fansMessageManage', 335, 2, 'Wchat/fansMessageManage', 1, 0, 20, '', '', '', 1, 1523673794, 0),
(11075, '粉丝留言', 'admin', 'wchat', 'fansMessageManage', 10156, 3, 'wchat/fansMessageManage', 1, 0, 1, '', '', '', 1, 1523673794, 0),
(11076, '群发消息', 'admin', 'Wchat', 'sendGroupMessage', 10156, 3, 'Wchat/sendGroupMessage', 1, 0, 2, '', '', '', 1, 1523673794, 0),
(11077, '售后服务', 'admin', 'Order', 'customerServiceList', 184, 2, 'Order/customerServiceList', 1, 0, 16, '售后服务', '', '', 1, 1523673820, 0),
(11078, '售后详情', 'admin', 'Order', 'orderCustomerDetail', 11077, 3, 'Order/orderCustomerDetail', 0, 0, 0, '售后详情', '', '', 1, 1523673820, 0),
(11079, '门店管理', 'admin', 'shop', 'pickuppointlist', 0, 3, 'shop/pickuppointlist', 0, 0, 0, '', '', '', 1, 1523673820, 0),
(11080, '优惠券发放记录', 'admin', 'promotion', 'couponGrantLog', 180, 3, 'promotion/couponGrantLog', 0, 0, 0, '', '', '', 1, 1523673820, 0),
(11081, '预售订单', 'admin', 'orderpresell', 'orderPresellList', 184, 2, 'orderpresell/orderPresellList', 1, 0, 3, '预售订单', '', '', 1, 1523673820, 0),
(11082, '专题活动', 'admin', 'promotion', 'topiclist', 179, 2, 'promotion/topiclist', 1, 0, 12, '', '', '', 1, 1523673820, 0),
(11083, '添加专题活动', 'admin', 'promotion', 'addtopic', 11082, 3, 'promotion/addtopic', 0, 0, 0, '', '', '', 1, 1523673820, 0),
(11084, '修改专题活动', 'admin', 'promotion', 'updatetopic', 11082, 3, 'promotion/updatetopic', 0, 0, 0, '', '', '', 1, 1523673820, 0),
(11085, '订单详情', 'admin', 'Orderpresell', 'orderDetail', 11081, 3, 'presellOrder/orderDetail', 1, 0, 0, '', '', '', 1, 1523673820, 0),
(11086, '核销设置', 'admin', 'Verification', 'index', 218, 2, 'Verification/index', 1, 0, 8, '', '', '', 1, 1523673822, 0),
(11087, '核销人员', 'admin', 'Verification', 'index', 11086, 3, 'Verification/index', 1, 0, 1, '', '', '', 1, 1523673822, 0),
(11088, '核销记录', 'admin', 'Verification', 'virtualGoodsVerificationList', 11086, 3, 'Verification/virtualGoodsVerificationList', 1, 0, 2, '', '', '', 1, 1523673822, 0),
(11089, '账户详情', 'admin', 'Commission', 'promoterAccount', 1002, 3, 'Commission/promoterAccount', 0, 0, 10, '账户详情', '', '', 1, 1523673822, 0),
(11090, '虚拟商品管理', 'admin', 'goods', 'virtualGoodsList', 150, 3, 'goods/virtualGoodsList', 1, 0, 1, '虚拟商品管理', '', '', 1, 1523673826, 0);
